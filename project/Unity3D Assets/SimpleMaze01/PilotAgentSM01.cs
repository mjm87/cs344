...
public class PilotAgentSM01 : Agent {
    ...
    public override void CollectObservations() {
        ...
        // TODO: add any other observations we want to feed it
        // TODO: consider benefit / challenge of adding a camera feed
    }
    ...
    private float DistanceToNearestWall()
    {
        ...
        {
            Debug.Log("Distance to " + hit.collider.name + ": " + hit.distance);
            return hit.distance;
        } else
        {
